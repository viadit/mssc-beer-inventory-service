...
* The original package name 'guru.springframework.mssc-beer-inventory-service' is invalid and this project uses 'guru.springframework.msscbeerinventoryservice' instead.
